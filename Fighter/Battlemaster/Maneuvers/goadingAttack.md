...
<p align="center">
  <img src="https://i.imgur.com/kJ9fhlb.png"/>
</p>
...
**``!alias $alias_name$ embed...``** - Changes the name to run the command. Replace ``goading`` in the command in the **Code** section.

...
<p align="center">
  <img src="https://i.imgur.com/jPiJoms.png"/>
</p>
...
-title "<name> {{"uses" if valid else "attempted to use"}} Maneuvering Attack!"
-desc "{{"When you hit a creature with a weapon attack, you can expend one superiority die to maneuver one of your comrades into a more advantageous position.\n\nYou add the superiority die to the attack’s damage roll, and you choose a friendly creature who can see or hear you. That creature can use its reaction to move up to half its speed without provoking opportunity attacks from the target of your attack." if valid else "A superiority die is expended when you use it. You regain all of your expended superiority dice when you finish a short or long rest. (``!g sr``)"}}"
...
**``!alias $alias_name$ embed...``** - Changes the name to run the command. Replace ``maneuvering`` in the command in the **Code** section.
